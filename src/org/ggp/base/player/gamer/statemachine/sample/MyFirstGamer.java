 ...
 *
 */
public final class MyFirstGamer extends SampleGamer
{
	@Override
...
//		long currentTime = System.currentTimeMillis();
		...
		// Assume it takes up to a second for action to be communicated to server.
		// 'timeout' is an absolute time value.
		...
		System.out.println("Metagaming done; " + numberOfStatesExplored + " states explored.");
	}
